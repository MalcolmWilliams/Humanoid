...
void goTo()
{
  ...
  {
    Serial.println(F("'goTo' requires an argument (0 to 180)"));
  }
}



void toggle(int delay_time)
{
  servothumb.write(30);
  delay(delay_time);
  servothumb.write(150);
  delay(delay_time);
}
...
void unrecognisedCommand(const char * commmand)
{
  ...
  Serial.println(F("Type '--help' or '-h' for help"));
}
